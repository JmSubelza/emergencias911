...
urlpatterns = [
    ...
    url(r'^vehiculo/detalle/(?P<pk>\d+)/$', login_required(VehiculoDetail.as_view()),
    ...
    url(r'^tipovehiculo/editar/(?P<pk>\d+)/$', login_required(TipoVehiculoUpdate.as_view()),
        name='tipo_vehiculo_editar'),
    url(r'^tipovehiculo/eliminar/(?P<pk>\d+)/$', login_required(TipoVehiculoDelete.as_view()),
        name='tipo_vehiculo_eliminar'),
    url(r'^tipovehiculo/detalle/(?P<pk>\d+)/$', login_required(TipoVehiculoDetail.as_view()),
    ...
    url(r'^centroemergencia/editar/(?P<pk>\d+)/$', login_required(CentroEmergenciaUpdate.as_view()),
    ...
    url(r'^dispositivogps/editar/(?P<pk>\d+)/$', login_required(DispositivoGpsUpdate.as_view()),
        name='dispositivo_gps_editar'),
    url(r'^dispositivogps/eliminar/(?P<pk>\d+)/$', login_required(DispositivoGpsDelete.as_view()),
        name='dispositivo_gps_eliminar'),
    url(r'^dispositivogps/detalle/(?P<pk>\d+)/$', login_required(DispositivoGpsDetail.as_view()),
